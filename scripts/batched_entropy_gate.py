...
#            print "\n{} {} Names: {}".format(len(targnames), len(imgnames), targnames)
            ...
            if train_style == 'kalman':
                startTime = time.time()
                out, out2, out3, out4 = model(input_var) #input hidden layer  
...
#            loss4.backward(retain_variables=True)
